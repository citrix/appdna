# SolutionVmTaskAppvCheckResult.AppVInstalled Property 
 

Indicates whether AppV software installed.
...
**C#**
```csharp
public bool AppVInstalled { get; set; }
```

**VB**
```vbnet
Public Property AppVInstalled As Boolean
	Get
	Set
```
