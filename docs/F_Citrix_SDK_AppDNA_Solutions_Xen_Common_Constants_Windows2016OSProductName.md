# Constants.Windows2016OSProductName Field
...
###C#
```csharp
public static readonly string Windows2016OSProductName
```

###VB
```vbnet
Public Shared ReadOnly Windows2016OSProductName As String
```
