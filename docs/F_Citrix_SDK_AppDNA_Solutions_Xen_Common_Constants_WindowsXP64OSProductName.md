# Constants.WindowsXP64OSProductName Field
...
###C#
```csharp
public static readonly string WindowsXP64OSProductName
```

###VB
```vbnet
Public Shared ReadOnly WindowsXP64OSProductName As String
```
