# ISolutionConfig.OutPackageDirectory Property 
 

Gets or sets the path to the out package directory.
...
**C#**
```csharp
string OutPackageDirectory { get; set; }
```

**VB**
```vbnet
Property OutPackageDirectory As String
	Get
	Set
```
