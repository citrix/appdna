# Constants.SolutionTemplateIdSetting Field
...
###C#
```csharp
public static readonly string SolutionTemplateIdSetting
```

###VB
```vbnet
Public Shared ReadOnly SolutionTemplateIdSetting As String
```
