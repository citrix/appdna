# Constants.Windows8x64Enterprise Field
 

"Windows 8 64-bit" OS name.
...
###C#
```csharp
public static readonly string Windows8x64Enterprise
```

###VB
```vbnet
Public Shared ReadOnly Windows8x64Enterprise As String
```
