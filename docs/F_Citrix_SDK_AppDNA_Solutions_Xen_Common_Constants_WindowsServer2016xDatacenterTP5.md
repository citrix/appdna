# Constants.WindowsServer2016xDatacenterTP5 Field
...
###C#
```csharp
public static readonly string WindowsServer2016xDatacenterTP5
```

###VB
```vbnet
Public Shared ReadOnly WindowsServer2016xDatacenterTP5 As String
```
