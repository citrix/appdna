# XenReportedApplication.DesktopPostImage Property 
 

Gets the image for target platform on desktop hosted deployment model.
...
###C#
```csharp
public abstract OSImage DesktopPostImage { get; }
```

###VB
```vbnet
Public MustOverride ReadOnly Property DesktopPostImage As OSImage
	Get
```
