...
Retrieves the string value assigned to this <a href="T_Citrix_SDK_AppDNA_ApplicationAttribute">ApplicationAttribute</a>.
 (Inherited from <a href="T_Citrix_SDK_AppDNA_ApplicationAttribute">ApplicationAttribute</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Citrix_SDK_AppDNA_StringAttribute_Value">Value</a></td><td>
Gets the value of attribute.
 (Overrides <a href="P_Citrix_SDK_AppDNA_ApplicationAttribute_1_Value">ApplicationAttribute(T).Value</a>.)</td></tr></table>&nbsp;
<a href="#stringattribute-class">Back to Top</a>
