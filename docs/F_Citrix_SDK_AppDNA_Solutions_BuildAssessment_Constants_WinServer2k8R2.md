# Constants.WinServer2k8R2 Field
 

"Windows Server 2008 R2" OS name.
...
###C#
```csharp
public static readonly string WinServer2k8R2
```

###VB
```vbnet
Public Shared ReadOnly WinServer2k8R2 As String
```
