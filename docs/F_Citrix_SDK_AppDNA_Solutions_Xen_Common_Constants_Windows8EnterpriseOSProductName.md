# Constants.Windows8EnterpriseOSProductName Field
...
###C#
```csharp
public static readonly string Windows8EnterpriseOSProductName
```

###VB
```vbnet
Public Shared ReadOnly Windows8EnterpriseOSProductName As String
```
