# Constants.Windows2000AdvancedOSProductName Field
...
###C#
```csharp
public static readonly string Windows2000AdvancedOSProductName
```

###VB
```vbnet
Public Shared ReadOnly Windows2000AdvancedOSProductName As String
```
