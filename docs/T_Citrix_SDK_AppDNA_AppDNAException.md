...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Citrix.SDK.AppDNA.AppDNAException<br />
...
public class AppDNAException : Exception
```

###VB
```vbnet
<SerializableAttribute>
Public Class AppDNAException
	Inherits Exception
```

The AppDNAException type exposes the following members.
...
Initializes a new instance of the AppDNAException class.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Citrix_SDK_AppDNA_AppDNAException__ctor_2">AppDNAException(String)</a></td><td>
Initializes a new instance of the AppDNAException class with a specified error message.</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Citrix_SDK_AppDNA_AppDNAException__ctor_1">AppDNAException(SerializationInfo, StreamingContext)</a></td><td>
Initializes a new instance of the AppDNAException class with serialized data.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Citrix_SDK_AppDNA_AppDNAException__ctor_3">AppDNAException(String, Exception)</a></td><td>
Initializes a new instance of the AppDNAException class with a specified error message and a reference to the inner exception that is the cause of this exception.</td></tr></table>&nbsp;
<a href="#appdnaexception-class">Back to Top</a>
