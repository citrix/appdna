# XenReportedApplication.AfterActionDesktopRag Property 
 

Gets the after action desktop rag.
...
**C#**
```csharp
public abstract ReportRag AfterActionDesktopRag { get; }
```

**VB**
```vbnet
Public MustOverride ReadOnly Property AfterActionDesktopRag As ReportRag
	Get
```
