# Constants.HyperVServer2012ProductName Field
...
###C#
```csharp
public static readonly string HyperVServer2012ProductName
```

###VB
```vbnet
Public Shared ReadOnly HyperVServer2012ProductName As String
```
