# Constants.ReplaceablePrerequisitesFolderName Field
 

The replaceable prerequisites folder name
...
###C#
```csharp
public const string ReplaceablePrerequisitesFolderName = "PrerequisitesFolder"
```

###VB
```vbnet
Public Const ReplaceablePrerequisitesFolderName As String = "PrerequisitesFolder"
```
