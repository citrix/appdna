...
This class is accessible from the PatchImpactAnalysisServer property and provides access to functionality related to a Patch Impact Analysis solution.


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;Citrix.SDK.AppDNA.Solutions.PatchImpactAnalysis.PatchImpactAnalysisSolutionService<br />
...
###C#
```csharp
public class PatchImpactAnalysisSolutionService
```
...
The PatchImpactAnalysisSolutionService type exposes the following members.
...
<a href="#patchimpactanalysissolutionservice-class">Back to Top</a>
