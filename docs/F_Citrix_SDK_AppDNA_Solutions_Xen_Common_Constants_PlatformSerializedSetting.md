# Constants.PlatformSerializedSetting Field
...
###C#
```csharp
public static readonly string PlatformSerializedSetting
```

###VB
```vbnet
Public Shared ReadOnly PlatformSerializedSetting As String
```
