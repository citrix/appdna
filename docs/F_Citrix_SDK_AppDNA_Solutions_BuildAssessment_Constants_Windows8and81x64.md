# Constants.Windows8and81x64 Field
 

"Windows 8/8.1 64-bit" OS name.
...
###C#
```csharp
public static readonly string Windows8and81x64
```

###VB
```vbnet
Public Shared ReadOnly Windows8and81x64 As String
```
