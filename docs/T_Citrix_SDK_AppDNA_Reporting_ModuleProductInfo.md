...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;Citrix.SDK.AppDNA.Reporting.ModuleProductInfo<br />
...
###C#
```csharp
public class ModuleProductInfo : IModuleProductInfo
```

###VB
```vbnet
Public Class ModuleProductInfo
	Implements IModuleProductInfo
```

The ModuleProductInfo type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Citrix_SDK_AppDNA_Reporting_ModuleProductInfo__ctor">ModuleProductInfo</a></td><td>
Initializes a new instance of the ModuleProductInfo class</td></tr></table>&nbsp;
<a href="#moduleproductinfo-class">Back to Top</a>
