# ProcessingInfo.IsAppv Property 
 

Gets or sets a value indicating whether the application is .appv package.
...
**C#**
```csharp
public bool IsAppv { get; }
```

**VB**
```vbnet
Public ReadOnly Property IsAppv As Boolean
	Get
```
