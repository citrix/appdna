# IssuesGroup.AdditionalFixableIssuesCount Property 
 

Gets the additional fixable issues count.
...
###C#
```csharp
public int AdditionalFixableIssuesCount { get; }
```

###VB
```vbnet
Public ReadOnly Property AdditionalFixableIssuesCount As Integer
	Get
```
