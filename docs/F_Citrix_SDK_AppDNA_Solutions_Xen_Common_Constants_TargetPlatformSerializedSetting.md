# Constants.TargetPlatformSerializedSetting Field
...
###C#
```csharp
public static readonly string TargetPlatformSerializedSetting
```

###VB
```vbnet
Public Shared ReadOnly TargetPlatformSerializedSetting As String
```
