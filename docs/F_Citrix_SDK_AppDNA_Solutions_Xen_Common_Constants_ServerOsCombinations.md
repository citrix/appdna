# Constants.ServerOsCombinations Field
...
###C#
```csharp
public static readonly Dictionary<string, List<string>> ServerOsCombinations
```

###VB
```vbnet
Public Shared ReadOnly ServerOsCombinations As Dictionary(Of String, List(Of String))
```
