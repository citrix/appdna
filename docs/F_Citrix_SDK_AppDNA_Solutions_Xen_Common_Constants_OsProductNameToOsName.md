# Constants.OsProductNameToOsName Field
...
###C#
```csharp
public static readonly Dictionary<string, List<string>> OsProductNameToOsName
```

###VB
```vbnet
Public Shared ReadOnly OsProductNameToOsName As Dictionary(Of String, List(Of String))
```
