# ApplicationWorkflow.PackageIssuesPath Property 
 

Gets the package issues path.
...
**C#**
```csharp
public string PackageIssuesPath { get; }
```

**VB**
```vbnet
Public ReadOnly Property PackageIssuesPath As String
	Get
```


#### Property Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/s1wwdcbf" target="_blank">String</a><br />The package issues path.
