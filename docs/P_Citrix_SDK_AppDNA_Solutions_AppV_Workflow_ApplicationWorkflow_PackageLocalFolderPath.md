# ApplicationWorkflow.PackageLocalFolderPath Property 
 

Gets or sets the local package folder.
...
###C#
```csharp
public string PackageLocalFolderPath { get; }
```

###VB
```vbnet
Public ReadOnly Property PackageLocalFolderPath As String
	Get
```
