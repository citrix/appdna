# XenReportedApplication.ServerPostImage Property 
 

Gets the image for target platform on server hosted deployment model.
...
###C#
```csharp
public abstract OSImage ServerPostImage { get; }
```

###VB
```vbnet
Public MustOverride ReadOnly Property ServerPostImage As OSImage
	Get
```
