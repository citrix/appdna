# Constants.ModuleNameToOsName Field
 

Resolves analysis module name by possible operating systems
...
###C#
```csharp
public static readonly Dictionary<string, List<string>> ModuleNameToOsName
```

###VB
```vbnet
Public Shared ReadOnly ModuleNameToOsName As Dictionary(Of String, List(Of String))
```
