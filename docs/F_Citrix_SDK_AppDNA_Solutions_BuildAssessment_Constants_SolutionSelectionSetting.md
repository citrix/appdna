# Constants.SolutionSelectionSetting Field
 

The solution selection setting name.
...
###C#
```csharp
public static readonly string SolutionSelectionSetting
```

###VB
```vbnet
Public Shared ReadOnly SolutionSelectionSetting As String
```
