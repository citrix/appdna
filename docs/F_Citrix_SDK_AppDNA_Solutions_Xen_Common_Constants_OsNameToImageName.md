# Constants.OsNameToImageName Field
...
###C#
```csharp
public static readonly Dictionary<string, string> OsNameToImageName
```

###VB
```vbnet
Public Shared ReadOnly OsNameToImageName As Dictionary(Of String, String)
```
