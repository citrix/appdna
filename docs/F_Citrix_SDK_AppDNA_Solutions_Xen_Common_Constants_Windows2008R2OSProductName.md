# Constants.Windows2008R2OSProductName Field
...
###C#
```csharp
public static readonly string Windows2008R2OSProductName
```

###VB
```vbnet
Public Shared ReadOnly Windows2008R2OSProductName As String
```
