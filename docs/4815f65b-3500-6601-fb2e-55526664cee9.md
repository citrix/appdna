# XenAdoptionSolution.IsValid Property 
...
#### Property Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/a28wyd50" target="_blank">Boolean</a><br />`true` if solution is valid; otherwise, `false`.
