# Constants.Windows2003OSProductName Field
...
###C#
```csharp
public static readonly string Windows2003OSProductName
```

###VB
```vbnet
Public Shared ReadOnly Windows2003OSProductName As String
```
