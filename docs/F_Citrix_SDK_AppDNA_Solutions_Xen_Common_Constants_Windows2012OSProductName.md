# Constants.Windows2012OSProductName Field
...
###C#
```csharp
public static readonly string Windows2012OSProductName
```

###VB
```vbnet
Public Shared ReadOnly Windows2012OSProductName As String
```
