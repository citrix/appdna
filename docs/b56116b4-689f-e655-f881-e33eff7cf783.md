# AlgorithmAction.IsSystem Property 
 

Gets a value indicating whether the action has been defined by the AppDNA product, as opposed to a user-defined action.
