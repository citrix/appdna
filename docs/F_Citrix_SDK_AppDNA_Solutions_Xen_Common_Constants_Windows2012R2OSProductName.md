# Constants.Windows2012R2OSProductName Field
...
###C#
```csharp
public static readonly string Windows2012R2OSProductName
```

###VB
```vbnet
Public Shared ReadOnly Windows2012R2OSProductName As String
```
