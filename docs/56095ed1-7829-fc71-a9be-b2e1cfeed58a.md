# XenSolutionPlatform.AlternateWin10Image Property 
...
**C#**
```csharp
public abstract XenSolutionPlatformImage AlternateWin10Image { get; }
```

**VB**
```vbnet
Public MustOverride ReadOnly Property AlternateWin10Image As XenSolutionPlatformImage
	Get
```
