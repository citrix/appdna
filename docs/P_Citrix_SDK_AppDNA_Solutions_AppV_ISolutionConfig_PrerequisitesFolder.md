# ISolutionConfig.PrerequisitesFolder Property 
 

Gets or sets App-V prerequisites folder.
...
###C#
```csharp
string PrerequisitesFolder { get; set; }
```

###VB
```vbnet
Property PrerequisitesFolder As String
	Get
	Set
```
