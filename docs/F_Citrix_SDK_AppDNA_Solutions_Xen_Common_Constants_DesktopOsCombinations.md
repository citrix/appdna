# Constants.DesktopOsCombinations Field
...
###C#
```csharp
public static readonly Dictionary<string, List<string>> DesktopOsCombinations
```

###VB
```vbnet
Public Shared ReadOnly DesktopOsCombinations As Dictionary(Of String, List(Of String))
```
