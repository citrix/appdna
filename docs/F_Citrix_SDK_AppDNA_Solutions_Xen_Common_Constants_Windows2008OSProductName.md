# Constants.Windows2008OSProductName Field
...
###C#
```csharp
public static readonly string Windows2008OSProductName
```

###VB
```vbnet
Public Shared ReadOnly Windows2008OSProductName As String
```
