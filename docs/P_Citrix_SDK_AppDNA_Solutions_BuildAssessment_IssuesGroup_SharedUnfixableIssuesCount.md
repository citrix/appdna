# IssuesGroup.SharedUnfixableIssuesCount Property 
 

Gets the shared unfixable issues count.
...
###C#
```csharp
public int SharedUnfixableIssuesCount { get; }
```

###VB
```vbnet
Public ReadOnly Property SharedUnfixableIssuesCount As Integer
	Get
```
