# Constants.OsProductNameToOsNamex64 Field
...
###C#
```csharp
public static readonly Dictionary<string, List<string>> OsProductNameToOsNamex64
```

###VB
```vbnet
Public Shared ReadOnly OsProductNameToOsNamex64 As Dictionary(Of String, List(Of String))
```
