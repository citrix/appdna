# Constants.SettingName Field
 

Token for the Solution Configuration
...
###C#
```csharp
public const string SettingName = "BuildAssessmentSolutonConfig"
```

###VB
```vbnet
Public Const SettingName As String = "BuildAssessmentSolutonConfig"
```
