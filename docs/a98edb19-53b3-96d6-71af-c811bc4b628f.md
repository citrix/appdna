# Constants.DisableDefenderExecutionProfile Field
 

The path for "Disable Defender" execution profile.
...
**C#**
```csharp
public const string DisableDefenderExecutionProfile = "Citrix.SDK.AppDNA.Solutions.AppV.ExecutionProfiles.Profiles.Disable Defender.xml"
```

**VB**
```vbnet
Public Const DisableDefenderExecutionProfile As String = "Citrix.SDK.AppDNA.Solutions.AppV.ExecutionProfiles.Profiles.Disable Defender.xml"
```
