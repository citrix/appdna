# XenReportedApplication.MergedModuleIdentifiers Property 
 

Gets the identifiers of the <a href="T_Citrix_SDK_AppDNA_ReportConfiguration">ReportConfiguration</a> objects which need to be merged to receive data for Server Hosted Deployment model.
