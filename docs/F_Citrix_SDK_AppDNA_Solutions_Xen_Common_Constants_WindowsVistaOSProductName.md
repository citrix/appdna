# Constants.WindowsVistaOSProductName Field
...
###C#
```csharp
public static readonly string WindowsVistaOSProductName
```

###VB
```vbnet
Public Shared ReadOnly WindowsVistaOSProductName As String
```
