# Constants.Win2016RuleModule Field
 

The Win2016 module identifier.
...
###C#
```csharp
public static readonly string Win2016RuleModule
```

###VB
```vbnet
Public Shared ReadOnly Win2016RuleModule As String
```
