# Constants.Windows2000OSProductName Field
...
###C#
```csharp
public static readonly string Windows2000OSProductName
```

###VB
```vbnet
Public Shared ReadOnly Windows2000OSProductName As String
```
