...
#### Property Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/a28wyd50" target="_blank">Boolean</a><br />`true` if the package will be tested by deplying it to the publishing server; otherwise, `false`.
