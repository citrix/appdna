# IssuesGroup.SharedIssuesRag Property 
 

Gets the shared issues rag.
...
**C#**
```csharp
public ReportRag SharedIssuesRag { get; }
```

**VB**
```vbnet
Public ReadOnly Property SharedIssuesRag As ReportRag
	Get
```
